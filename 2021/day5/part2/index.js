      ...
      if (startX !== endX && startY !== endY) {
        if (startX < endX) {
          ...
          for (let index = 0; index <= endX - startX; index++) {
            if (isUpward) {
              field[startY - index][startX + index] =
                field[startY - index][startX + index] + 1;
            } else {
              field[startY + index][startX + index] =
                field[startY + index][startX + index] + 1;
            }
          ...
          for (let index = 0; index <= startX - endX; index++) {
            if (isUpward) {
              field[endY + index][endX + index] =
                field[endY + index][endX + index] + 1;
            } else {
              field[endY - index][endX + index] =
                field[endY - index][endX + index] + 1;
            }
